...
const Index = () => {
  ...
  const categoryButtons = [
    ...
    { key: 'shorts', label: 'Shorts', count: videos.filter(v => v.category === 'shorts').length },
    { key: 'full', label: 'Full Videos', count: videos.filter(v => v.category === 'full').length },
  ];
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {stats.map((stat, index) => (
              <div key={index} className="text-center space-y-4 group animate-fade-in hover:scale-110 transition-all duration-500" style={{ animationDelay: `${index * 0.1}s` }}>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16 animate-fade-in">
              <h2 className="text-4xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent">About Ganeshdrsr</h2>
            ...
            <div className="grid md:grid-cols-2 gap-16 items-center">
              <div className="space-y-8 animate-slide-in-left">
                ...
                <div className="space-y-6">
                  {[
                    "Proven dropshipping strategies that generate real results",
                    "Step-by-step tutorials for beginners and advanced users",
                    "Market research and product selection guidance",
                    "Marketing and scaling techniques for sustainable growth"
                  ].map((item, index) => (
              ...
              {totalPages > 1 && (
                <div className="flex justify-center items-center gap-4 animate-fade-in">
                  <Button
                    ...
                    className="bg-white/70 dark:bg-slate-800/70 hover:bg-white dark:hover:bg-slate-800"
                  >
                    Previous
                  </Button>
          ...
          <div className="max-w-6xl mx-auto text-center space-y-12 animate-fade-in">
            ...
            <div className="grid md:grid-cols-3 gap-12 mt-16">
              {[
                ...
                <div key={index} className="space-y-6 group animate-slide-in-up hover:scale-105 transition-all duration-500" style={{ animationDelay: `${index * 0.2}s` }}>
                  <div className="relative">
