...
const Header = () => {
  ...
  return (
    <header className="fixed top-0 w-full bg-slate-900/95 backdrop-blur-md border-b border-white/10 z-50">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {isMenuOpen && (
          <div className="md:hidden py-4 animate-fade-in bg-slate-900/95 backdrop-blur-sm rounded-b-lg border-t border-white/10">
